  ...
  <body>
	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary" class="js-fullheight text-center">
			<h1 id="colorlib-logo"><a href="../e_pasala.html#AL"><span class="img" style="background-image: url(../assets/images/e_pasala/art.jpg);"></span>A/L Arts</a></h1>
			<nav id="colorlib-main-menu" role="navigation">
			<!-------remove following classes if wanted to place navbar under by under------->
				<ul class="nav nav-pills nav-stacked">
					<li><a href="../index.php"><i class="fa fa-home"></i>Home</a></li>
					<li><a href="#MEDIA"><i class="fa fa-superscript"></i>Media</a></li>
					<li><a href="#SINHALA"><i class="fa fa-calculator"></i>Sinhala</a></li>
					<li><a href="#GEOGRAPHY"><i class="fa fa-vials"></i>Geography</a></li>
		...
		<div id="colorlib-main">
			...
			<div id="MEDIA">
				<section class="ftco-section ftco-bread">
				  ...
				  <div class="col-md-8 ftco-animate">
					<p class="breadcrumbs"><span class="mr-2"><a href="../index.php">Home</a></span> <span><a href="../e_pasala.html">E PASALA</a></span> <span>Art</span></p>
					<h1 class="bread">Media</h1>
				  </div>
				</div>
					</div>
				</section>
				<section class="ftco-section contact-section">
				  <div class="container">
					  <div class="mb-4">
						<h2 class="h3 font-weight-bold">A/L Media past papers</h2>
					  </div>
				  ...
				  <div class="container">
					  <div class="mb-4">
						<h2 class="h3 font-weight-bold">A/L Media model papers</h2>
					  </div>
					<div class="row block-9">
					  <div class="col-md-12 d-flex">
					  <h5>
			...
			<div id="SINHALA">
				...
				<section class="ftco-section contact-section">
				  <div class="container">
					  <div class="mb-4">
						<h2 class="h3 font-weight-bold">A/L Sinhala past papers</h2>
					  </div>
					<div class="row block-9">
					  <div class="col-md-12 d-flex">
					  <h5>
				  ...
				  <div class="container">
					  <div class="mb-4">
						<h2 class="h3 font-weight-bold">A/L Sinhala model papers</h2>
					  </div>
					<div class="row block-9">
					  <div class="col-md-12 d-flex">
					  <h5>
			...
			<div id="GEOGRAPHY">
				...
				<section class="ftco-section contact-section">
				  <div class="container">
					  <div class="mb-4">
						<h2 class="h3 font-weight-bold">A/L Geography past papers</h2>
					  </div>
					<div class="row block-9">
					  <div class="col-md-12 d-flex">
					  <h5>
				  ...
				  <div class="container">
					  <div class="mb-4">
						<h2 class="h3 font-weight-bold">A/L Geography model papers</h2>
					  </div>
					<div class="row block-9">
					  <div class="col-md-12 d-flex">
					  <h5>
