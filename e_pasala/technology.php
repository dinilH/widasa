  ...
  <body>
	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary" class="js-fullheight text-center">
			<h1 id="colorlib-logo"><a href="../e_pasala.html#AL"><span class="img" style="background-image: url(../assets/images/e_pasala/technology.jpg);"></span>A/L Technology</a></h1>
			<nav id="colorlib-main-menu" role="navigation">
			<!-------remove following classes if wanted to place navbar under by under------->
				<ul class="nav nav-pills nav-stacked">
					<li><a href="../index.php"><i class="fa fa-home"></i>Home</a></li><hr>
					<li><a href="#ICT"><i class="fa fa-laptop"></i>ICT</a></li><hr>
					<li><a href="#ET"><i class="fa fa-cogs"></i>ET</a></li><hr>
					<li><a href="#SFT"><i class="fa fa-vials"></i>SFT</a></li><hr>
					<!--<li><a href="#BST"><i class="fa fa-microscope"></i>BST</a></li><hr>-->
				</ul>
			</nav>
		...
		<div id="colorlib-main">
			...
			<div id="ICT">
				<section class="ftco-section ftco-bread">
				  ...
				  <div class="col-md-8 ftco-animate">
					<p class="breadcrumbs"><span class="mr-2"><a href="../index.php">Home</a></span> <span><a href="../e_pasala.html">E PASALA</a></span> <span>Technology</span></p>
					<h1 class="bread">ICT</h1>
				  </div>
				</div>
					</div>
				</section>
				<section id="loadICTotherPages" class="ftco-section contact-section">
				  <div class="container">
					  <div class="mb-4">
						<h2 class="h3 font-weight-bold">A/L  ICT past papers</h2>
					  </div>
					<div class="row block-9">
					  <div class="col-md-12 d-flex">
					  <h5>
						<ul class="fa-ul">
						  <li><a style="color:black;" href="../assets/files/technology/2019_AL_ICT_I.pdf" target="_blank"><span class="fa-li"><i class="fas fa-file" style="color:#45b6fe;"></i></span>2019 AL ICT MCQ Sinhala</a></li>
						  <li><a style="color:black;" href="../assets/files/technology/2019_AL_ICT_II.pdf" target="_blank"><span class="fa-li"><i class="fas fa-file" style="color:#45b6fe;"></i></span>2019 AL ICT Structured Essay & Essay Sinhala </a></li>
						  <li><a style="color:black;" href="../assets/files/technology/2018_AL_ICT_I.pdf" target="_blank"><span class="fa-li"><i class="fas fa-file" style="color:#45b6fe;"></i></span>2018 AL ICT MCQ Sinhala</a></li>
						  <li><a style="color:black;" href="../assets/files/technology/2018_AL_ICT_II.pdf" target="_blank"><span class="fa-li"><i class="fas fa-file" style="color:#45b6fe;"></i></span>2018 AL ICT Structured Essay Sinhala</a></li>
						  ...
						  <li><a style="color:black;" href="../assets/files/technology/2013_AL_ICT_I.pdf" target="_blank"><span class="fa-li"><i class="fas fa-file" style="color:#45b6fe;"></i></span>2013 AL ICT MCQ Sinhala</a></li>
						  <li><a style="color:black;" href="../assets/files/technology/2012_AL_ICT_I,II.pdf" target="_blank"><span class="fa-li"><i class="fas fa-file" style="color:#45b6fe;"></i></span>2012 AL ICT I,II Sinhala</a></li>
						</ul>
					  </h5>
					  </div>
					</div>
					...
					<div class="container">
					  <div class="mb-4">
						<h2 class="h3 font-weight-bold">A/L  ICT marking schemes</h2>
					  </div>
					<div class="row block-9">
					  <div class="col-md-12 d-flex">
					  <h5>
						<ul class="fa-ul">
						  <li><a style="color:black;" href="../assets/files/technology/2018_AL_ICT_marking_scheme.pdf" target="_blank"><span class="fa-li"><i class="fas fa-file" style="color:#45b6fe;"></i></span>2018 AL ICT marking scheme</a></li>
				  ...
				  <div class="container">
					  <div class="mb-4">
						<h2 class="h3 font-weight-bold">A/L  ICT model papers</h2>
					  </div>
					<div class="row block-9">
					  <div class="col-md-12 d-flex">
					  <h5>
						<ul class="fa-ul">
						  <li><a style="color:black;" href="../assets/files/technology/AL_ICT_modal_I,II.pdf" target="_blank"><span class="fa-li"><i class="fas fa-file" style="color:#45b6fe;"></i></span>අ.පො.ස. උසස් පෙළ ICT මූලාකෘති ප්‍රශ්න පත්‍රය </a></li>
						  <!--<li><a style="color:black;" href="../assets/files/technology/2019 AL ICT Structured Essay & Essay Sinhala widasa.com.pdf" target="_blank"><span class="fa-li"><i class="fas fa-file" style="color:#45b6fe;"></i></span>2019 AL ICT Structured Essay & Essay Sinhala </a></li>
			...
			<div id="ET">
				...
				<section class="ftco-section contact-section">
				  <div class="container">
					  <div class="mb-4">
						<h2 class="h3 font-weight-bold">A/L  ET past papers</h2>
					  </div>
					<div class="row block-9">
					  <div class="col-md-12 d-flex">
					  <h5>
						<ul class="fa-ul">
						  <li><a style="color:black;" href="../assets/files/technology/2018_AL_ET_I,II.pdf" target="_blank"><span class="fa-li"><i class="fas fa-file" style="color:#45b6fe;"></i></span>2018 AL ET I,II</a></li>
						  <li><a style="color:black;" href="../assets/files/technology/2017_AL_ET_I,II.pdf" target="_blank"><span class="fa-li"><i class="fas fa-file" style="color:#45b6fe;"></i></span>2017 AL ET I,II </a></li>
				  ...
				  <div class="container">
					  <div class="mb-4">
						<h2 class="h3 font-weight-bold">A/L  ET marking schemes</h2>
					  </div>
					<div class="row block-9">
					  <div class="col-md-12 d-flex">
					  <h5>
						<ul class="fa-ul">
						  <li><a style="color:black;" href="../assets/files/technology/2018_AL_ET_marking_scheme.pdf" target="_blank"><span class="fa-li"><i class="fas fa-file" style="color:#45b6fe;"></i></span>2018 AL ET marking scheme</a></li>
			...
			<div id="SFT">
				...
				<section class="ftco-section contact-section">
				  <div class="container">
					  <div class="mb-4">
						<h2 class="h3 font-weight-bold">A/L  SFT past papers</h2>
					  </div>
					<div class="row block-9">
					  <div class="col-md-12 d-flex">
					  <h5>
						<ul class="fa-ul">
						  ...
						  <li><a style="color:black;" href="../assets/files/technology/2018_AL_SFT_I,II.pdf" target="_blank"><span class="fa-li"><i class="fas fa-file" style="color:#45b6fe;"></i></span>2018 AL SFT I,II</a></li>
						  <li><a style="color:black;" href="../assets/files/technology/2017_AL_SFT_I,II.pdf" target="_blank"><span class="fa-li"><i class="fas fa-file" style="color:#45b6fe;"></i></span>2017 AL SFT I,II</a></li>
						  <li><a style="color:black;" href="../assets/files/technology/2016_AL_SFT_I,II.pdf" target="_blank"><span class="fa-li"><i class="fas fa-file" style="color:#45b6fe;"></i></span>2016 AL SFT I,II</a></li>
						</ul>
					  </h5>
					  </div>
					</div>
					...
					<div class="container">
					  <div class="mb-4">
						<h2 class="h3 font-weight-bold">A/L  SFT marking schemes</h2>
					  </div>
					<div class="row block-9">
					  <div class="col-md-12 d-flex">
					  <h5>
						<ul class="fa-ul">
						  <li><a style="color:black;" href="../assets/files/technology/2018_AL_SFT_marking_scheme.pdf" target="_blank"><span class="fa-li"><i class="fas fa-file" style="color:#45b6fe;"></i></span>2018 AL SFT marking scheme</a></li>
						  <!--<li><a style="color:black;" href="../assets/files/technology/2018_AL_ET_marking_scheme.pdf" target="_blank"><span class="fa-li"><i class="fas fa-file" style="color:#45b6fe;"></i></span>2018 AL ET marking scheme</a></li>
						  <li><a style="color:black;" href="../assets/files/technology2018_AL_ICT_marking_scheme.pdf" target="_blank"><span class="fa-li"><i class="fas fa-file" style="color:#45b6fe;"></i></span>2018 AL ICT marking scheme</a></li>
						  <!--<li><a style="color:black;" href="../assets/files/technology/2018 AL ICT Structured Essay Sinhala widasa.com.pdf" target="_blank"><span class="fa-li"><i class="fas fa-file" style="color:#45b6fe;"></i></span>2018 AL ICT Structured Essay Sinhala</a></li>-->
						</ul>
					  </h5>
					  </div>
				  ...
				  <!--<div class="container">
					  <div class="mb-4">
						<h2 class="h3 font-weight-bold">A/L  SFT model papers</h2>
					  </div>
					<div class="row block-9">
					  <div class="col-md-12 d-flex">
					  <h5>
			...
			<!--<div id="BST">
				...
				<section class="ftco-section contact-section">
				  <div class="container">
					  <div class="mb-4">
						<h2 class="h3 font-weight-bold">A/L  BST past papers</h2>
					  </div>
					<div class="row block-9">
					  <div class="col-md-12 d-flex">
					  <h5>
				  ...
				  <div class="container">
					  <div class="mb-4">
						<h2 class="h3 font-weight-bold">A/L  BST model papers</h2>
					  </div>
					<div class="row block-9">
					  <div class="col-md-12 d-flex">
					  <h5>
	        ...
	        <div class="row mb-5">
	          <div class="col-md">
	            <div class="ftco-footer-widget mb-4 ml-md-4">
	              <h2 class="ftco-heading-2">Advanced Level</h2>
	              <ul class="list-unstyled photo">
				    <li><a href="technology.php" class="img" style="background-image: url(../assets/images/e_pasala/technology.jpg);"></a></li>
	                <li><a href="maths.php" class="img" style="background-image: url(../assets/images/e_pasala/maths.jpg);"></a></li>
	                <li><a href="science.php" class="img" style="background-image: url(../assets/images/e_pasala/science.jpg);"></a></li>
	                <li><a href="commerce.php" class="img" style="background-image: url(../assets/images/e_pasala/commerce.jpg);"></a></li>
	                <li><a href="art.php" class="img" style="background-image: url(../assets/images/e_pasala/art.jpg);"></a></li>
