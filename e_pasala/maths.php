  ...
  <body>
	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary" class="js-fullheight text-center">
			<h1 id="colorlib-logo"><a href="../e_pasala.html#AL"><span class="img" style="background-image: url(../assets/images/e_pasala/maths.jpg);"></span>A/L Maths</a></h1>
			<nav id="colorlib-main-menu" role="navigation">
			<!-------remove following classes if wanted to place navbar under by under------->
				<ul class="nav nav-pills nav-stacked">
					<li><a href="../index.php"><i class="fa fa-home"></i>Home</a></li>
					<li><a href="#PHYSICS"><i class="fa fa-superscript"></i>Physics</a></li>
					<li><a href="#COMBINED"><i class="fa fa-calculator"></i>Combined Maths</a></li>
					<li><a href="#CHEMISTRY"><i class="fa fa-vials"></i>Chemistry</a></li>
					<li><a href="#ICTheader"><i class="fa fa-laptop"></i>ICT</a></li>
				</ul>
			</nav>
		...
		<div id="colorlib-main">
			...
			<!----------------------------------------------------------------PHYSICS SECTION----------------------------------------------Dinil Hansara2--------------------------->
			<div id="PHYSICS">
				<section class="ftco-section ftco-bread">
					<div class="container">
						<div class="row no-gutters slider-text justify-content-center align-items-center">
				  <div class="col-md-8 ftco-animate">
					<p class="breadcrumbs"><span class="mr-2"><a href="../index.php">Home</a></span> <span><a href="../e_pasala.html">E PASALA</a></span> <span>Maths</span></p>
					<h1 class="bread">Physics</h1>
				  </div>
				</div>
					</div>
				</section>
				<!----------------------------Following id should change if wanted to load physics to other pages------------------------------------------>
				<section id="loadPHYSICSotherPages" class="ftco-section contact-section">
				  <div class="container">
					  <div class="mb-4">
						<h2 class="h3 font-weight-bold">A/L  Physics past papers</h2>
					  </div>
					<div class="row block-9">
					  <div class="col-md-12 d-flex">
					  <h5>
						<ul class="fa-ul">
						  <li><a style="color:black;" href="../assets/files/maths/2017 AL Physics Structured widasa.com.pdf" target="_blank"><span class="fa-li"><i class="fas fa-file" style="color:#45b6fe;"></i></span>2017 AL Physics Structured</a></li>
						  <li><a style="color:black;" href="../assets/files/maths/2019 AL ICT Structured Essay & Essay Sinhala widasa.com.pdf" target="_blank"><span class="fa-li"><i class="fas fa-file" style="color:#45b6fe;"></i></span>2019 AL ICT Structured Essay & Essay Sinhala </a></li>
						  <li><a style="color:black;" href="../assets/files/maths/2018 AL ICT MCQ Sinhala widasa.com.pdf" target="_blank"><span class="fa-li"><i class="fas fa-file" style="color:#45b6fe;"></i></span>2018 AL ICT MCQ Sinhala</a></li>
						  <li><a style="color:black;" href="../assets/files/maths/2018 AL ICT Structured Essay Sinhala widasa.com.pdf" target="_blank"><span class="fa-li"><i class="fas fa-file" style="color:#45b6fe;"></i></span>2018 AL ICT Structured Essay Sinhala</a></li>
						</ul>
					  </h5>
					  </div>
					</div>
				  ...
				  <div class="container">
					  <div class="mb-4">
						<h2 class="h3 font-weight-bold">A/L  Physics model papers</h2>
					  </div>
					<div class="row block-9">
					  <div class="col-md-12 d-flex">
					  <h5>
			...
			<!-----------------------------------------------------------------------END OF PHYSICS SECTION-------------------------------------------------------------------------dinil hansara--->
			...
			<div id="COMBINED">
				<section class="ftco-section ftco-bread">
				  ...
				  <div class="col-md-8 ftco-animate">
					<p class="breadcrumbs"><span class="mr-2"><a href="../index.php">Home</a></span> <span><a href="../e_pasala.html">E PASALA</a></span> <span>Maths</span></p>
					<h1 class="bread">Combined Maths</h1>
				  </div>
				</div>
					</div>
				</section>
				<section class="ftco-section contact-section">
				  <div class="container">
					  <div class="mb-4">
						<h2 class="h3 font-weight-bold">A/L Combined maths past papers</h2>
					  </div>
					<div class="row block-9">
					  <div class="col-md-12 d-flex">
					  <h5>
				  ...
				  <div class="container">
					  <div class="mb-4">
						<h2 class="h3 font-weight-bold">A/L  Combined maths model papers</h2>
					  </div>
					<div class="row block-9">
					  <div class="col-md-12 d-flex">
					  <h5>
			...
			<div id="CHEMISTRY">
				...
				<!----------------------------Following id should change if wanted to load chemistry to other pages-------------------------------------------------Mr.Dinil------------>
				<section id="loadCHEMISTRYotherPages" class="ftco-section contact-section">
				  <div class="container">
					  <div class="mb-4">
						<h2 class="h3 font-weight-bold">A/L Chemistry past papers</h2>
					  </div>
					<div class="row block-9">
					  <div class="col-md-12 d-flex">
					  <h5>
				  ...
				  <div class="container">
					  <div class="mb-4">
						<h2 class="h3 font-weight-bold">A/L Chemistry model papers</h2>
					  </div>
					<div class="row block-9">
					  <div class="col-md-12 d-flex">
					  <h5>
			...
			<!----------------------------------------------------------------ICT SECTION------------------------------------------------------------------------->
			<section id="ICTheader" class="ftco-section ftco-bread">
					<div class="container">
						<div class="row no-gutters slider-text justify-content-center align-items-center">
				  <div class="col-md-8 ftco-animate">
					<p class="breadcrumbs"><span class="mr-2"><a href="../index.php">Home</a></span> <span><a href="../e_pasala.html">E PASALA</a></span> <span>Maths</span></p>
			...
			<div id="ICT">
					<!--ICT section in technology.php will load hear to avoid repitition-->
			</div>
			<!-----------------------------------------------------------------------END OF ICT SECTION---------------------------------------------------------------------------->
...
-->
  ...
  <script src="../assets/js/AboutUs/main.js"></script>
	...
	<script>
	/*loading ICT from technology section*/
		$(document).ready(function(){			 
			$("#ICT").load("technology.php #loadICTotherPages");
		});
	</script>
  </body>
  </html>