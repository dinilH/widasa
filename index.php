...
if(!isset($_COOKIE["widasaUser"]) and !isset($_COOKIE["widasaPass"])) {
   ...
   $_SESSION['suser']=$_COOKIE["widasaUser"];
   $_SESSION['spassword']=$_COOKIE["widasaPass"];
...
{
	$_SESSION['adminLoginOk']=$_COOKIE["widasaAdminLogin"];
}
}
/*
$sql="CREATE DATABASE IF NOT EXISTS widasa";
if ($conn->query($sql) === TRUE) {
  
} else {
  echo "<script>alert('Error creating database Please create it mannually sir! database එක CD එකේ තියෙනෝ   database සර්ගේ එකට  import කරගන්න නැත්තන් web site එක වැඩ කරන්නේ නෑ')</script> ";
}*/
?>
<html>
<head>
    ...
    <div>
      <div class="collapse navbar-collapse" id="myNavbar">
		...
		<ul class="nav navbar-nav navbar-right">
				<a href="login.html" style=" color: inherit;"><button class="button" style="vertical-align:middle border:0px; border-radius:30px;"><span>Login</span></button></a> 
				<a href="signup/signup.html" style=" color: inherit; "><button class="button" style="vertical-align:middle; border:0px; border-radius:30px; background-color:#EE5F00;"><span>Signup </span></button></a>
		</ul>		
      </div>
    </div>
  </div>
...
owl.owlCarousel({
	...
	smartSpeed:2000,
		...
		<!--cards-->
	<div  id="TopFeatures" class="cardrow well text-center">
	<div class="row">
		<div class="col-md-12">
			<h1>Top Features</h1>
		</div>
					...
					<div class="card">
					  <a style="text-decoration: none;" href="knowledge_hub.html">
						<img src="assets/images/knowledge_hub.jpg" alt="Avatar" style="width:100%; height:105%;">
						  <!--<div class="cardtext">
								<h1 class="maintex"><b>knowledge_hub </b></h1> 
