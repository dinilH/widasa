<?php
											/*remove the mail comment pallehama*/
session_start();
...
if(isset($_POST['contactReply']))
{
		$msgId=$_POST['msgId'];
		echo $msgId; 
		/*$sql = "UPDATE messages SET new=0 WHERE id='$msgId'";*/


$to = "dragonhansara@gmail.com";
...
<div style='margin: 0; padding: 10; background:hotpink;'>
...
// More headers
$headers .= 'From: <Dinil(Widasa)@widasa.com>' . "\r\n";

/*mail($to,$subject,$message,$headers);*/																					/*remove the comment*/
/*
if ($conn->query($sql) === TRUE) {
	echo "success";*/
  /*header('location:admin/dist/admin.php');*/
/*} else {
  echo "Error updating new messages: " . $conn->error;
}*/
