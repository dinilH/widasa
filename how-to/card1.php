		...
		<div class="col-md-2 col-xs-3 LeftnRightcolums text-center">
			...
			<div class="col-md-8 col-xs-7 d-flex justify-content-center">
				<div class="center_topic text-center">
					<h1>වෙබ් නිර්මාණය  #1</h1>
				</div>
				<div>
					<img class="insideImg1" alt="img" src="../assets/images/how_to/web1.jpg" width="600" height="400">
				<hr>
				</div>
				<div class="text-center parahTopic">
					<h1><b>වෙබ් නිර්මාණය පිළිබඳ හැඳින්වීම</b></h1>
				</div>
										<!--1-->
				<div class="parah1">
					<p>
					වෙබ් නිර්මාණය (web designing)යනු වෙබ් අඩවියක දෘශ්‍ය කොටස සහ පිටු පිරිසැලසුමයි. ස්ථිතික වෙබ් අඩවියක් හෝ ගතික වෙබ් යෙදුමක් නිර්මාණය කිරීමේදී
					එය වෙබ් සංවර්ධනය (web development) සමඟ අත්වැල් බැඳගනී .
					<br><br>
					
					ඔබ  ඔබව නිර්මාණශීලී පුද්ගලයෙකු ලෙස නොසැලකුවද, web designing ඉගෙන ගැනීම හොඳ අදහසකි. ඔබට ස්ථිතික වෙබ් අඩවි(static) 
					හෝ ගතික වෙබ් යෙදුම් සෑදීමට අවශ්‍ය වුවත් , web designing එම ක්‍රියාවලියේ වැදගත් අංගයකි. වෙබ් අඩවියකට පැමිණෙන විට මිනිසුන් දකින පළමු දෙය 
					මෙම සැලසුම(design) වන අතර එය ප්‍රමාණවත් නොවේ නම් ඔවුන් පිටව යනු ඇත.
					<br><br>
					
					ඔබ නිර්මාණශීලී පුද්ගලයෙකු ලෙස ඔබව හඳුනා ගන්නේ නම්, ඔබ වෙබ් නිර්මාණකරුවෙකු ලෙස වෘත්තියක් සලකා බැලිය හැකිය. අද වන විට 
					updated skills ඇති දක්ෂ වෙබ් නිර්මාණකරුවන් සඳහා විශාල අවශ්‍යතාවයක් පවතී.
					</p>
				</div>
				<hr>
									<!--2-->
				<div class="text-center parahTopic">
						<h1><b>Web Designing සංකල්ප</b></h1>
				</div>
				<img class="insideImg1" alt="img" src="../assets/images/how_to/web2.jpeg" width="600" height="400">
				
				<div class="parah1">
				වෙබ් නිර්මාණ ක්‍රියාවලිය ආරම්භ වන්නේ දෘශ්‍ය සංකල්පයකින්(visual concept) වන අතර, එය ඔබට අතින් හෝ Photoshop වැනි මෘදුකාංග සමඟ සටහන් කළ හැකිය.
				(මෙය අත්‍යාවශ්‍ය පියවරක් නොවීමට හැක)
				ඉන්පසු, ඔබ වෙබ් අඩවිය තැනීම සඳහා HTML සහ CSS භාවිතා කරයි . HTML සහ CSS යනු වෙබ් පිටු ලිවීමේ codes වේ. HTML ඔබේ පිටුවේ මූලික ව්‍යුහය
				හසුරුවන අතර CSS styles සහ පෙනුම හසුරුවයි.
				<br><br>
				...
				*<span style="color:#4CAF50;">Accessibility</span> යනු ඉතා වැදගත් වෙබ් නිර්මාණ පුහුණුවකි. මෙයින් සිදුවන්නේ බිහිරි සහ අන්ධ අය 
				...
				<!--read more / check the loginok by dh RCG galle-->
